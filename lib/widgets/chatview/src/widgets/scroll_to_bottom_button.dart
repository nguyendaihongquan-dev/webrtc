          ...
          child: InkWell(
            onTap: () {
              ...
              scrollController?.animateTo(
                0,
                duration:
                    scrollToBottomButtonConfig?.scrollAnimationDuration ??
            ...
            child: Container(
              decoration: BoxDecoration(
                borderRadius:
                    scrollToBottomButtonConfig?.borderRadius ??
                    BorderRadius.circular(50),
                border:
                    scrollToBottomButtonConfig?.border ??
              ...
              child:
                  scrollToBottomButtonConfig?.icon ??
                  const Icon(
