...
class ReactionPopup extends StatefulWidget {
  const ReactionPopup({Key? key, required this.onTap, required this.showPopUp})
    : super(key: key);
...
class ReactionPopupState extends State<ReactionPopup>
  ...
  late final AnimationController _animationController = AnimationController(
    vsync: this,
    duration:
        reactionPopupConfig?.animationDuration ??
                ...
                builder: (context, child) => Transform.scale(
                  ...
                  child: reactionPopupConfig?.showGlassMorphismEffect ?? false
                      ...
                      : Container(
                          ...
                          margin:
                              reactionPopupConfig?.margin ??
                              const EdgeInsets.symmetric(horizontal: 25),
                          padding:
                              reactionPopupConfig?.padding ??
                          ...
                          decoration: BoxDecoration(
                            color:
                                reactionPopupConfig?.backgroundColor ??
                                Colors.white,
  ...
  Widget get _reactionPopupRow => EmojiRow(
    onEmojiTap: (emoji) {
      ...
      if (currentUser != null && _message != null) {
        ...
        reactionPopupConfig?.userReactionCallback?.call(_message!, emoji);
      }
    },
  );
